...
var React13, import_react, isBrowser2, hasOwnProperty, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
...
var React19, import_prop_types8, import_jsx_runtime3, GlobalStyles_default;
...
function createBox(options = {}) {
  ...
  const Box2 = React20.forwardRef(function Box3(inProps, ref) {
...
var React20, import_jsx_runtime4, _excluded4;
...
var React21, ThemeContext2, ThemeContext_default;
var init_ThemeContext = __esm({
  "node_modules/@mui/private-theming/useTheme/ThemeContext.js"() {
    React21 = __toESM(require_react());
    ThemeContext2 = React21.createContext(null);
    if (true) {
...
var React23, import_prop_types10, import_jsx_runtime5, ThemeProvider_default;
...
var React24, import_prop_types11, import_jsx_runtime6, EMPTY_THEME, ThemeProvider_default2;
...
var React25, import_jsx_runtime7, DEFAULT_MODE_STORAGE_KEY, DEFAULT_COLOR_SCHEME_STORAGE_KEY, DEFAULT_ATTRIBUTE;
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React26.useCallback((mode) => {
  ...
  const setColorScheme = React26.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React26.useCallback((e) => {
  ...
  const mediaListener = React26.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React27.createContext(void 0);
  const useColorScheme = () => {
    const value = React27.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider({
    ...
    const hasMounted = React27.useRef(false);
    const upperTheme = useTheme4();
    const ctx = React27.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime9.jsxs)(React27.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime9.jsxs)(React27.Fragment, {
...
var React27, import_prop_types12, import_jsx_runtime8, import_jsx_runtime9, _excluded6, DISABLE_CSS_TRANSITION;
...
function createContainer(options = {}) {
  ...
  const Container2 = React28.forwardRef(function Container3(inProps, ref) {
...
var React28, import_prop_types13, import_jsx_runtime10, _excluded8, defaultTheme, defaultCreateStyledComponent, useThemePropsDefault, useUtilityClasses;
...
function createGrid(options = {}) {
  ...
  const OverflowContext = React29.createContext(void 0);
  ...
  const Grid2 = React29.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React29.useContext(OverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime11.jsx)(GridRoot, _extends({
      ...
      children: React29.Children.map(children, (child) => {
        if (React29.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
var React29, import_prop_types15, import_jsx_runtime11, _excluded9, defaultTheme2, defaultCreateStyledComponent2;
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(React30.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React30.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var React30, import_prop_types17, import_jsx_runtime12, _excluded10, defaultTheme3, defaultCreateStyledComponent3, getSideFromDirection, style3;
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CLICQHZF.js.map
